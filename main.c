    ...
    while (1) {
        ...
        for(int j=0; j<700; j+=1) {
            ...
            if(clearThisLine >= 10) {
                points += 10;
                lines += 1;
                char aa[10];sprintf(aa,"Blocks: %d, Points: %d, Lines: %d",blocks,points,lines);SetWindowTextA(hwnd,aa);
                clearBlocks[count] = j;
                ++ count;
            }
        }
        ...
        if(choice == 'sq') {
            HBRUSH brush = CreateSolidBrush(RGB(250, 250, 0));
            ...
            if(sq.y0 > 650 || sq.y1 > 650 || sq.y2 > 650 || sq.y3 > 650) {
                //printf("%d",blocks); //AddItem (squarelist, sq);
                b[sq.x0][sq.y0] = 1;
                b[sq.x1][sq.y1] = 1;
                b[sq.x2][sq.y2] = 1;
                b[sq.x3][sq.y3] = 1;
            ...
            if(lne.y0 > 650 || lne.y1 > 650 || lne.y2 > 650 || lne.y3 > 650) {
                //printf("%d",blocks); //AddItemLine (linelist, lne);
                b[lne.x0][lne.y0] = 1;
                b[lne.x1][lne.y1] = 1;
                b[lne.x2][lne.y2] = 1;
                b[lne.x3][lne.y3] = 1;
