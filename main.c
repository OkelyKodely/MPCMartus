...
WNDCLASSEX wc;
HWND hwnd, hwnd_title, hwnd_next, hwnd_lines, hwnd_points, hwnd_blocks, hwnd_level;
MSG Msg;
...
DWORD WINAPI downs(void *data) {
    while (1) {
        ...
        if(choice == "sq") {
            ...
            HBRUSH brush = CreateSolidBrush(RGB(4, 4, 204));
            ...
            brush = CreateSolidBrush(RGB(4, 4, 204));
