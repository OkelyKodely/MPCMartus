    ...
    switch(msg)
    {
        ...
        case WM_PAINT:
        {
            if(fist) {
                ...
                DeleteObject(brush);
                HBRUSH brush0 = CreateSolidBrush(RGB(255, 0, 0));
...
void printMiscLabels(int stage) {
    ...
    SelectObject(hdc2, font);
    if(v < 100)
        TextOut(hdc2, 450, 120, bb, 9);
    else
        TextOut(hdc2, 450, 120, bb, 10);
    DeleteObject(font);
